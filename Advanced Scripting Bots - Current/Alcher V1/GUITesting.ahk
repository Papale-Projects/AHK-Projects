...
Gui, Add, Text, cYellow x40 y55 w900 h20 vFletchCount1 +BackgroundTrans,Alchs:
...
Gui, Add, Text, cYellow x270 y115 w900 h20 vMissClick1 +BackgroundTrans,Cam Moves: 0
...
FletchCount()
{
	GuiControl,,FletchCount1,Alchs: %TotalFletched%
}
return
...
MissClickGui()
{
	GuiControl,,MissClick1,Cam Moves: %MissClick2%
}
return
