...
Gui, Add, Text, cYellow x40 y55 w900 h20 vFletchCount1 +BackgroundTrans,Alter Runs: 0
...
Gui, Add, Text, cYellow x270 y95 w900 h20 vAntibanMove1 +BackgroundTrans,MouseMoves: 0
Gui, Add, Text, cYellow x270 y115 w900 h20 vMissClick1 +BackgroundTrans,Target Misclicks: 0
Gui, Add, Text, cYellow x270 y135 w900 h20 vPlayerSLevel1 +BackgroundTrans,BagFix: 0
...
FletchCount()
{
	GuiControl,,FletchCount1,Alter Runs: %TotalFletched%
}
return
