...
Gui, Add, Text, cYellow x40 y55 w900 h20 vFletchCount1 +BackgroundTrans,Laps Completed:
...
Gui, Add, Text, cYellow x270 y115 w900 h20 vMissClick1 +BackgroundTrans,Marks Collected: 0
...
FletchCount()
{
	GuiControl,,FletchCount1,Laps Completed: %TotalFletched%
}
return
...
MissClickGui()
{
	GuiControl,,MissClick1,Marks Collected: %MissClick2%
}
return
