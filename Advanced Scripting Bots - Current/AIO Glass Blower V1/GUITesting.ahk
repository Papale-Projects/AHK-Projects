...
Gui, Add, Text, cYellow x40 y55 w900 h20 vFletchCount1 +BackgroundTrans,Orbs Created:
...
FletchCount()
{
	GuiControl,,FletchCount1,Orbs Created: %TotalFletched%
}
return
...
LoggedOutFor()
{
	If (counter >= 28800)
	{
		...
		{
			Logout()
			MsgBox, "You have reached the daily limit." %counter%
			Exitapp
		}
	}
