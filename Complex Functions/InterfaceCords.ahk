...
;OUTDATED VERSION THAT USES SET PIXEL POSITIONS AND GLOBAL VARIABLES
...
;Updates version using the GDI+ class to calculate the location of all tabs
;Imagesearch used to find the sword icon of the first tab
